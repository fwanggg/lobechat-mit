...
export class Meta {
  public generate({
    description = 'Family-OS offers you the best ChatGPT, OLLaMA, Gemini, Claude WebUI user experience',
    title,
    image = '/og/cover.png',
    url,
    type = 'website',
    ...
    const siteTitle = title.includes('Family-OS') ? title : title + ' · Family-OS';
    return {
